...
/**
 * Die Starter Klasse startet das Menu und verwaltet alle Fenster.
...
public class Starter extends JFrame {
    ...
    Menu menu;
    /**
     * Im Konstruktor von Starter werden die Parameter des JFrames gesetzt.
     */
    public Starter() {


        //Bestimmt die Eigenschaften des JFrames Starter()
    ...
    /**
     * Wird beim Programmstart aufgerufen und erzeugt eine neue Instanz von Starter();.
    ...
    /**
     * Startet das Spiel entweder normal oder im Sandbox Modus (Erzeugt eine neue Instanz von Board)
     * @param sandBox
     */
    public void startGame(boolean sandBox) {
        setTitle("Board");
        //Erzeugt eine neue Instanz von Board und bestimmt ihre Eigenschaften
    ...
    /**
     * Öffnet eine neue Instanz von RegistrationForm und übergibt ihr die aktuellen Rundenwerte (die dieser Methode als Parameter übergeben werden).
     * @param score
     * @param wave
     * @param kills
     * @param shotsFired
    ...
    /**
     * Öffnet eine neue Instanz von DisplayTable
     */
    ...
    /**
     * Öffnet eine neue Instanz von Einstellungen
     */
